...
#### Ejemplo Real
El ataque de ransomware WannaCry en 2017 afectó a más de 200,000 sistemas en 150 países, incluyendo hospitales y empresas, utilizando una vulnerabilidad conocida en Windows (Perlroth, 2017).
...
#### Ejemplo Real
En 2019, un ataque de SQL Injection comprometió más de 20 millones de registros de clientes de la empresa Desjardins, exponiendo nombres, direcciones y datos financieros (Desjardins, 2019).
...
#### Ejemplo Real
En 2021, la vulnerabilidad de día cero en Microsoft Exchange Server permitió que atacantes accedieran a miles de servidores en todo el mundo (Goodin, 2021).
...
#### Ejemplo Real
En 2020, múltiples proveedores de DNS fueron atacados mediante DNS Spoofing, redirigiendo tráfico de usuarios a sitios fraudulentos que recolectaban credenciales de acceso (ZDNet, 2020).
...
- Perlroth, N. (2017). The WannaCry Ransomware Attack. *The New York Times*. URL: [https://www.nytimes.com](https://www.nytimes.com)
- ZDNet (2020). DNS Spoofing Attacks Surge Amid Pandemic. URL: [https://www.zdnet.com](https://www.zdnet.com)
